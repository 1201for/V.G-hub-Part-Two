...
local Toggle1 = Section1:CreateToggle("AutoFarm", Settings.Cum, function(State)
Settings.Cum = State
spawn(function()
    while wait(0.1) do
        pcall(function()
...
local Toggle1 = Section1:CreateToggle("Skip Hatch Egg Anamtion", Settings.No, function(State)
Settings.No = State
